...
export default defineConfig({
  ...
  redirects: {
    ...
    '/posts/multi-panel-plot-di-grads': '/tutorials/multi-panel-plot-di-grads',
    ...
    '/posts/install-ww3': '/tutorials/install-ww3',
    ...
    '/blog/install-ww3': '/tutorials/install-ww3',
    '/blog/multi-panel-plot-di-grads': '/tutorials/multi-panel-plot-di-grads',
  },
});
